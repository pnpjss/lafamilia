...
<div class="settings-grid">
        ...
        <div class="grid-item3"><p>change password</p></div>
        ...
        <form action="/app/settings/edit-bio.php" method="POST">
            <label for="bio"></label>
                <textarea name="bio" id="bio" cols="30" rows="6" placeholder="<?php echo $user['biography']; ?>"></textarea><br>
            <button type="submit">Update bio</button></form></div>
        <div class="grid-item7">Bio</div>

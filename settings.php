        ...
        <div class="settings-grid-container">
            ...
            <div class="settings-item update-form">
                <form action="/settings.php" method="post">
                    ...
                    <button name="submit-email" type="submit">update email</button>
                </form>
            </div>
            ...
            <div class="settings-item update-form">
                <form action="settings.php" method="post">
                    ...
                    <button name="submit-password" type="submit">password</button>
                </form>
            </div>
            <div>change bio</div>
            <div>
                <form action="settings.php" method="POST">
                    <label for="bio"></label>
                    <textarea name="bio" id="bio" cols="25" rows="6" placeholder="<?= $_SESSION['user']['biography']; ?>" maxlength="100"></textarea>
                    <button name="submit-bio" type="submit">Update bio</button>
                </form>
            </div>
        </div>
    </section>
